...
$users->db_loadSQL('SELECT distinct pu.nom, pu.email, pu.user_id, pu.login, pu.visible_planning, pu.couleur, pu.droits, pug.nom AS nom_groupe, COUNT(pp.periode_id) AS "totalPeriodes"
